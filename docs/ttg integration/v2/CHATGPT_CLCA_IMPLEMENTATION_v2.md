...
```json
{
  ...
  "properties": {
    ...
    "status": { "type": "string", "enum": ["draft", "published", "pending", "archived", "deleted"] },
...
```json
{
  ...
  "images": [{ "url": "https://ttg-cdn.example.com/events/4567/photo1.jpg", "caption": "Game setup" }],
  "ownerSystem": "ttg",
...
* produce a Cloud Run / Cloud Function ingestion project that *consumes* this schema and validates incoming payloads (complete `Dockerfile`, `package.json`, and tested TS function), OR
