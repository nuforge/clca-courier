...
// TEMPORARILY DISABLED: Legacy interfaces removed during migration
...
export const useSiteStore = defineStore('site', () => {
  ...
  // TEMPORARILY DISABLED: Legacy store methods during migration to ContentDoc
  ...
  // TEMPORARILY DISABLED: Legacy computed properties
