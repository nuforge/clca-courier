              ...
              <q-slide-transition>
                <div v-show="showFilters">
                  ...
                  <div class="row q-mb-md">
                    ...
                    <div class="col-12 col-sm-6 col-md-3 q-pa-md">
                      <q-toggle v-model="filters.hasDescription" label="With Descriptions" color="purple"
                        @update:model-value="onFilterChange"
                        aria-label="Show only newsletters with descriptions for screen readers" />
                    </div>

                    <div class="col-12 col-sm-6 col-md-3 q-pa-md">
                      <q-toggle v-model="filters.hasSearchableText" label="Text Searchable" color="orange"
                        @update:model-value="onFilterChange"
                        aria-label="Show only newsletters with searchable text content" />
                    </div>

                    <div class="col-12 col-sm-6 col-md-3 q-pa-md">
                      <q-toggle v-model="filters.hasThumbnail" label="With Thumbnails" color="teal"
                        @update:model-value="onFilterChange"
                  ...
                  <div class="row items-center">
                    ...
                    <div v-if="hasActiveFilters" class="" role="list" aria-label="Active filters">
                      ...
                      <q-chip v-if="filters.featured" removable @remove="filters.featured = false; onFilterChange()"
                        color="positive" text-color="white" dense role="listitem">
                        Featured
                      </q-chip>
