                            ...
                            <q-card :class="cardClasses">
                                <q-card-section>
                                    ...
                                    <q-form @submit="onSubmit" class="q-col-gutter-md">
                                        ...
                                        <div class="row q-col-gutter-md">
                                            <div class="col-12 col-sm-6">
                                                <q-select v-model="form.ideaType" :options="ideaTypeOptions"
                                                    label="Idea Category" filled
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <q-select v-model="form.priority" :options="priorityOptions"
                                                    label="Priority Level" filled>
                                                    <template v-slot:prepend>
                                        ...
                                        <q-input v-model="form.ideaTitle" label="Idea Title/Summary" filled
                                            hint="Brief title that describes your idea"
                                        ...
                                        <q-input v-model="form.description" label="Detailed Description" type="textarea"
                                            rows="6" filled
                                        ...
                                        <q-input v-model="form.benefits" label="Benefits & Impact" type="textarea"
                                            rows="4" filled
                                        ...
                                        <q-input v-model="form.implementation" label="Implementation Ideas (Optional)"
                                            type="textarea" rows="4" filled
                                            hint="Do you have thoughts on how this could be implemented or put into action?">
                                            <template v-slot:prepend>
                                                <q-icon name="mdi-cog" />
                                            </template>
                                        </q-input>

                                        <q-input v-model="form.resources" label="Resources Needed (Optional)"
                                            type="textarea" rows="3" filled
                                            hint="What resources (time, money, people, tools) might be needed?">
                                            <template v-slot:prepend>
                                        ...
                                        <q-input v-model="form.additionalInfo" label="Additional Information (Optional)"
                                            type="textarea" rows="3" filled
                                            hint="Any other relevant information, examples, or context">
                                            <template v-slot:prepend>
                                        ...
                                        <div class="text-center q-mt-md">
                                            <q-btn type="submit" color="positive" icon="mdi-send" label="Submit Ideas"
