                            ...
                            <q-card flat bordered>
                                <q-card-section>
                                    ...
                                    <q-form @submit="onSubmit" class="q-gutter-md">
                                        ...
                                        <q-select v-model="form.subject" :options="subjectOptions" label="Subject"
                                            filled :rules="[val => !!val || 'Subject is required']">
                                            <template v-slot:prepend>
                                                <q-icon name="mdi-tag" />
                                            </template>
                                        </q-select>
                                        ...
                                        <div class="text-center">
                                            <q-btn type="submit" color="primary" icon="mdi-send" label="Send Message"
                                                :loading="submitting" />
                                        </div>
                                    </q-form>
                                </q-card-section>
