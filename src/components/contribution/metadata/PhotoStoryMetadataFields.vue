  ...
  <div class="photo-story-metadata-fields">
    <div class="row q-gutter-md">
      <div class="col-12 col-md-6">
        <q-input
          v-model="localMetadata.photographerName"
          label="Photographer Name (Optional)"
          outlined
          placeholder="Who took these photos?"
          @update:model-value="updateMetadata"
        />
      </div>
      <div class="col-12 col-md-6">
        <q-input
          v-model="photographyDateStr"
          label="Photography Date (Optional)"
          outlined
          type="date"
    ...
    <div class="row q-gutter-md q-mt-md">
      ...
      <div class="col-12 col-md-6">
        <q-input
          v-model="localMetadata.cameraInfo"
          label="Camera Information (Optional)"
          outlined
          placeholder="Camera model, settings, etc."
          @update:model-value="updateMetadata"
        />
      </div>
    </div>
