  ...
  <div class="classified-metadata-fields">
    <div class="row q-gutter-md">
      <div class="col-12 col-md-4">
        <q-input
          v-model.number="localMetadata.price"
      ...
      <div class="col-12 col-md-4">
        <q-select
          v-model="localMetadata.contactMethod"
    ...
    <div class="row q-gutter-md q-mt-md" v-if="showCondition">
      <div class="col-12 col-md-6">
        <q-select
          v-model="localMetadata.condition"
