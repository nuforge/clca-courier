    ...
    <div class="article-metadata-fields">
        <div class="row">
            <div class="col-12 col-md-6 q-pa-md">
                <q-input v-model="localMetadata.subtitle" label="Subtitle (Optional)" outlined
                    placeholder="A brief subtitle for your article" @update:model-value="updateMetadata" />
            </div>
            <div class="col-12 col-md-6 q-pa-md">
                <q-input v-model.number="localMetadata.readTime" label="Estimated Read Time (minutes)" outlined
                    type="number" min="1" max="60" placeholder="5" @update:model-value="updateMetadata" />
            </div>
        </div>

        <div class="row q-mt-md">
            <div class="col-12 q-pa-md">
                <q-select v-model="localMetadata.tags" label="Tags (Optional)" outlined multiple use-chips use-input
                    input-debounce="300" new-value-mode="add-unique" :options="tagOptions"
