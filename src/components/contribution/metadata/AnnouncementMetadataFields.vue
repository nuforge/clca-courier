<template>
  <div class="announcement-metadata-fields">
    ...
    <div class="row q-gutter-md q-mt-md">
      <div class="col-12 col-md-6">
        <q-input
          v-model="localMetadata.contactPerson"
          label="Contact Person (Optional)"
          outlined
          placeholder="Who to contact for questions"
          @update:model-value="updateMetadata"
        />
      </div>
      <div class="col-12 col-md-6">
        <q-toggle
          v-model="localMetadata.actionRequired"
          label="Action Required from Residents"
          @update:model-value="updateMetadata"
        />
      </div>
    </div>
    ...
    <div class="row q-gutter-md q-mt-md">
      <div class="col-12">
        <q-select
          v-model="localMetadata.affectedAreas"
