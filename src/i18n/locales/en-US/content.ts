...
export default {
  ...
  activeInLayout: 'Active in layout',
  layoutArea: 'Layout Area',
  inLayout: 'In Layout',
  noContentInIssue: 'No content in this issue',
  dragContentHere: 'Drag content from available list',
  existingNewsletterReadonly: 'This is an existing newsletter with fixed content',
  emptyContentArea: 'Empty content area',
  ...
  calendar: {
    ...
    noUpcomingEventsDesc: 'No events scheduled for today or later this month',
