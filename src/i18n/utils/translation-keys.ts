...
export const TRANSLATION_KEYS = {
  ...
  CONTENT: {
    ...
    CALENDAR: {
      ...
      NO_EVENTS_THIS_MONTH: 'content.calendar.noEventsThisMonth',
      NO_EVENTS_THIS_MONTH_DESC: 'content.calendar.noEventsThisMonthDesc',
      NO_UPCOMING_EVENTS: 'content.calendar.noUpcomingEvents',
      NO_UPCOMING_EVENTS_DESC: 'content.calendar.noUpcomingEventsDesc',
      UPCOMING_EVENTS: 'content.calendar.upcomingEvents',
      ALL_EVENTS: 'content.calendar.allEvents',
      ALL_UPCOMING_EVENTS: 'content.calendar.allUpcomingEvents',
      EXPAND_ALL: 'content.calendar.expandAll',
      COLLAPSE_ALL: 'content.calendar.collapseAll',
      EVENTS_ON_DATE: 'content.calendar.eventsOnDate',
      EVENTS_FOR_MONTH: 'content.calendar.eventsForMonth',
      ...
      SELECT_EVENT_FOR_DETAILS: 'content.calendar.selectEventForDetails',
      SELECT_EVENT_FOR_DETAILS_DESC: 'content.calendar.selectEventForDetailsDesc',
      EVENT: 'content.calendar.event',
  ...
  FOOTER: {
    ...
    BRAND_NAME: 'footer.brandName',
    DESCRIPTION: 'footer.description',
    LOCATION: 'footer.location',
    QUICK_LINKS: 'footer.quickLinks',
    COMMUNITY_CONTENT: 'footer.communityContent',
    ISSUE_ARCHIVE: 'footer.issueArchive',
    INTERACTIVE_MAP: 'footer.interactiveMap',
    CLASSIFIEDS: 'footer.classifieds',
    COMMUNITY: 'footer.community',
    ABOUT_CONTACT: 'footer.aboutContact',
    CONTRIBUTE: 'footer.contribute',
    ACCESSIBILITY: 'footer.accessibility',
    STAY_CONNECTED: 'footer.stayConnected',
    NEWSLETTER_DESCRIPTION: 'footer.newsletterDescription',
    EMAIL_PLACEHOLDER: 'footer.emailPlaceholder',
    CONTACT: 'footer.contact',
    PUBLISHED_SEASONALLY: 'footer.publishedSeasonally',
    FOLLOW_US: 'footer.followUs',
    FACEBOOK: 'footer.facebook',
    TWITTER: 'footer.twitter',
    INSTAGRAM: 'footer.instagram',
    EMAIL: 'footer.email',
    COMMUNITY_NOTE: 'footer.communityNote',
    WELCOME_MESSAGE: 'footer.welcomeMessage'
  },
  ...
  SETTINGS_PAGE: {
    ...
    BROWSER_NOTIFICATIONS: 'pages.settingsPage.browserNotifications',
    NEW_ISSUE_ALERTS: 'pages.settingsPage.newIssueAlerts',
    EVENT_REMINDERS: 'pages.settingsPage.eventReminders',
    DISPLAY_SETTINGS: 'pages.settingsPage.displaySettings',
    DISPLAY_DESCRIPTION: 'pages.settingsPage.displayDescription',
    DISPLAY_BEHAVIOR: 'pages.settingsPage.displayBehavior',
    COMPACT_MODE: 'pages.settingsPage.compactMode',
    COMPACT_MODE_DESCRIPTION: 'pages.settingsPage.compactModeDescription',
    SHOW_TIMESTAMPS: 'pages.settingsPage.showTimestamps',
    ANIMATE_TRANSITIONS: 'pages.settingsPage.animateTransitions',
    ENABLE_ANIMATIONS: 'pages.settingsPage.enableAnimations',
    ENABLE_ANIMATIONS_DESCRIPTION: 'pages.settingsPage.enableAnimationsDescription',
    AUTOPLAY_VIDEOS: 'pages.settingsPage.autoplayVideos',
    AUTOPLAY_VIDEOS_DESCRIPTION: 'pages.settingsPage.autoplayVideosDescription',
    PDF_SETTINGS: 'pages.settingsPage.pdfSettings',
    PDF_DESCRIPTION: 'pages.settingsPage.pdfDescription',
    PDF_VIEWER: 'pages.settingsPage.pdfViewer',
    PDF_VIEWER_PREFERENCES: 'pages.settingsPage.pdfViewerPreferences',
    DEFAULT_ZOOM: 'pages.settingsPage.defaultZoom',
    DEFAULT_ZOOM_LEVEL: 'pages.settingsPage.defaultZoomLevel',
    CURRENT: 'pages.settingsPage.current',
    ...
    PAGE_LAYOUT: 'pages.settingsPage.pageLayout',
    SINGLE_PAGE: 'pages.settingsPage.singlePage',
    FACING_PAGES: 'pages.settingsPage.facingPages',
    COVER_PAGE: 'pages.settingsPage.coverPage',
    THUMBNAIL_SIZE: 'pages.settingsPage.thumbnailSize',
    SMALL: 'pages.settingsPage.small',
    MEDIUM: 'pages.settingsPage.medium',
    LARGE: 'pages.settingsPage.large',
    TIME_FORMAT_SETTINGS: 'pages.settingsPage.timeFormatSettings',
    TIME_FORMAT_DESCRIPTION: 'pages.settingsPage.timeFormatDescription',
    TIME_FORMAT_PREFERENCE: 'pages.settingsPage.timeFormatPreference',
    AUTO_TIME_FORMAT: 'pages.settingsPage.autoTimeFormat',
    TWELVE_HOUR_FORMAT: 'pages.settingsPage.twelveHourFormat',
    TWENTY_FOUR_HOUR_FORMAT: 'pages.settingsPage.twentyFourHourFormat',
    TIME_FORMAT_EXAMPLE: 'pages.settingsPage.timeFormatExample',
    BACKUP_SETTINGS: 'pages.settingsPage.backupSettings',
    BACKUP_DESCRIPTION: 'pages.settingsPage.backupDescription',
    SETTINGS_MANAGEMENT: 'pages.settingsPage.settingsManagement',
    EXPORT_SETTINGS: 'pages.settingsPage.exportSettings',
    IMPORT_SETTINGS: 'pages.settingsPage.importSettings',
    RESET_TO_DEFAULTS: 'pages.settingsPage.resetToDefaults',
    RESET_ALL: 'pages.settingsPage.resetAll',
    EXPORT_DESCRIPTION: 'pages.settingsPage.exportDescription',
